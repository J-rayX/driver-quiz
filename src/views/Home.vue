<template>
  <div class="home">
    ...
    <main>
      ...
      <section class="section-2 container">
        ...
        <div class="row">
          <div class="col-md-6 parent">
            <div class="step-text child align-middle">
              <h6>1. Select your Course</h6>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus
                nesciunt asperiores ipsa voluptate porro magnam amet a sapiente
                ex quis.
              </p>
            </div>
          </div>
          <div class="col-md-6">
            <img src="../assets/step_1_image.png" alt />
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <h6>2. Pay a Deposit</h6>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus
              nesciunt asperiores ipsa voluptate porro magnam amet a sapiente ex
              quis.
            </p>
          </div>
        </div>
      ...
      <section class="area section-4">
        <div class="container">
          <h1 class="text-dark">Our Courses</h1>
          <p class="text-secondary">Lorem ipsum dolor sit amet.</p>

          <div class="row">
            <div class="col-md-4 col-12 card-parent text-center">
              <div class="card mr-2 d-inline-block shadow-lg">
                <div class="card-img-top">
                  <img
      ...
      <!-- <section class="section-5 p-0 text-center">
        <div class="container-fluid">
          <div class="col-md-12 col-sm-12">
            ...
            <p>
              You can sign up through all platforms to get book a course and
              fixed a plan
            </p>
          </div>
          <div class="row">
